...
console.log(`Practice readiness: ${audit.summary.practiceReady} ready, ${audit.summary.rhythmicDraft} rhythmic draft, ${audit.summary.melodyDraft} melody-only draft, ${audit.summary.reviewRequired} review required`);
