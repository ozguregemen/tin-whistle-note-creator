...
import {
  addEstimatedOctaves, extractScoreAssets, extractTextPhrases, musicXmlToPhrases, phrasesToString,
...
test("MusicXML içindeki üst porte melodisini ölçü gruplarıyla okur", () => {
  const xml = `<?xml version="1.0"?><score-partwise><part id="P1">
    <measure number="1"><note><pitch><step>A</step><octave>4</octave></pitch><voice>1</voice><staff>1</staff></note><note><pitch><step>C</step><alter>1</alter><octave>5</octave></pitch><voice>1</voice><staff>1</staff></note></measure>
    <measure number="2"><note><rest/><duration>1</duration></note><note><pitch><step>D</step><octave>5</octave></pitch><voice>1</voice><staff>1</staff></note><note><chord/><pitch><step>F</step><octave>5</octave></pitch></note></measure>
